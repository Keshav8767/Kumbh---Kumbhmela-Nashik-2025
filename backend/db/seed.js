...
const hotels = [
  { name: 'Hotel Panchavati Yatri', zone: 'Ramkund', location: 'Near Ramkund Ghat, 200m from main bathing area', coordinates: { lat: 19.8770, lng: 73.4340 }, type: 'mid-range', amenities: ['AC', 'WiFi', 'Restaurant', 'Parking'], priceRange: { min: 1500, max: 3000 }, contact: { phone: '+91-253-2570301', email: 'panchavati@hotel.com' }, rating: 4.2, availableRooms: 8, totalRooms: 25, status: 'available' },
  { name: 'Ginger Hotel Nashik', zone: 'Trimbakeshwar', location: 'Trimbak Road, Near Temple Entrance', coordinates: { lat: 19.9340, lng: 73.5340 }, type: 'mid-range', amenities: ['AC', 'WiFi', 'Restaurant', '24/7 Service'], priceRange: { min: 2000, max: 4000 }, contact: { phone: '+91-253-6666000', email: 'ginger@hotel.com' }, rating: 4.5, availableRooms: 12, totalRooms: 40, status: 'available' },
  { name: 'Express Inn', zone: 'Gate 1', location: 'North Gate Complex, Bus Stand Area', coordinates: { lat: 19.8855, lng: 73.4255 }, type: 'budget', amenities: ['Fan', 'WiFi', 'Basic Dining'], priceRange: { min: 800, max: 1500 }, contact: { phone: '+91-253-2345678', email: 'express@hotel.com' }, rating: 3.5, availableRooms: 5, totalRooms: 20, status: 'available' },
  { name: 'Lily Sarovar Portico', zone: 'Tapovan', location: 'Tapovan Meditation Area, Peaceful Location', coordinates: { lat: 19.8810, lng: 73.4410 }, type: 'luxury', amenities: ['AC', 'WiFi', 'Restaurant', 'Spa', 'Pool', 'Gym'], priceRange: { min: 4000, max: 8000 }, contact: { phone: '+91-253-6619999', email: 'lily@hotel.com' }, rating: 4.8, availableRooms: 15, totalRooms: 50, status: 'available' },
  { name: 'Kumbh Residency', zone: 'Gate 2', location: 'East Gate, Near Parking Area', coordinates: { lat: 19.8702, lng: 73.4452 }, type: 'budget', amenities: ['Fan', 'Basic Dining'], priceRange: { min: 600, max: 1200 }, contact: { phone: '+91-253-2456789', email: 'kumbh@hotel.com' }, rating: 3.2, availableRooms: 3, totalRooms: 15, status: 'available' },
  { name: 'Nashik Grand', zone: 'Ramkund', location: 'Ramkund Main Road, City Center', coordinates: { lat: 19.8765, lng: 73.4335 }, type: 'luxury', amenities: ['AC', 'WiFi', 'Restaurant', 'Bar', 'Conference Hall'], priceRange: { min: 5000, max: 10000 }, contact: { phone: '+91-253-2580000', email: 'grand@hotel.com' }, rating: 4.6, availableRooms: 20, totalRooms: 60, status: 'available' },
  { name: 'Pilgrim Lodge', zone: 'Gate 3', location: 'South Gate, Near Food Court', coordinates: { lat: 19.8652, lng: 73.4302 }, type: 'budget', amenities: ['Fan', 'WiFi', 'Shared Bathroom'], priceRange: { min: 400, max: 800 }, contact: { phone: '+91-253-2567890', email: 'pilgrim@lodge.com' }, rating: 3.0, availableRooms: 10, totalRooms: 30, status: 'available' },
  { name: 'Trimbak Heritage Hotel', zone: 'Trimbakeshwar', location: 'Temple Road, Heritage Property', coordinates: { lat: 19.9335, lng: 73.5335 }, type: 'luxury', amenities: ['AC', 'WiFi', 'Restaurant', 'Heritage Tours', 'Cultural Programs'], priceRange: { min: 6000, max: 12000 }, contact: { phone: '+91-253-2690000', email: 'heritage@hotel.com' }, rating: 4.7, availableRooms: 8, totalRooms: 25, status: 'available' },
  { name: 'Budget Stay Inn', zone: 'Gate 4', location: 'West Gate, Information Center Nearby', coordinates: { lat: 19.8752, lng: 73.4202 }, type: 'budget', amenities: ['Fan', 'Basic Dining'], priceRange: { min: 500, max: 1000 }, contact: { phone: '+91-253-2678901', email: 'budget@hotel.com' }, rating: 3.3, availableRooms: 6, totalRooms: 18, status: 'available' },
  { name: 'Tapovan Retreat', zone: 'Tapovan', location: 'Ashram Road, Quiet Area', coordinates: { lat: 19.8805, lng: 73.4405 }, type: 'mid-range', amenities: ['AC', 'WiFi', 'Yoga Classes', 'Meditation Hall'], priceRange: { min: 2500, max: 5000 }, contact: { phone: '+91-253-2689012', email: 'retreat@hotel.com' }, rating: 4.4, availableRooms: 10, totalRooms: 30, status: 'available' },
  { name: 'Dharamshala Kumbh', zone: 'Gate 5', location: 'VIP Gate Area, Government Facility', coordinates: { lat: 19.8802, lng: 73.4352 }, type: 'dharamshala', amenities: ['Fan', 'Shared Facilities', 'Free Meals'], priceRange: { min: 0, max: 200 }, contact: { phone: '+91-253-2690123', email: 'dharamshala@gov.in' }, rating: 3.8, availableRooms: 50, totalRooms: 100, status: 'available' },
  { name: 'Sangam View Hotel', zone: 'Ramkund', location: 'Overlooking Sangam Point', coordinates: { lat: 19.8768, lng: 73.4338 }, type: 'mid-range', amenities: ['AC', 'WiFi', 'Restaurant', 'River View'], priceRange: { min: 2000, max: 4500 }, contact: { phone: '+91-253-2701234', email: 'sangam@hotel.com' }, rating: 4.3, availableRooms: 7, totalRooms: 22, status: 'available' },
  { name: 'Nashik Inn', zone: 'Gate 1', location: 'Near Bus Stand, Easy Access', coordinates: { lat: 19.8850, lng: 73.4250 }, type: 'budget', amenities: ['Fan', 'WiFi'], priceRange: { min: 700, max: 1400 }, contact: { phone: '+91-253-2712345', email: 'nashikinn@hotel.com' }, rating: 3.4, availableRooms: 4, totalRooms: 16, status: 'available' },
  { name: 'Royal Palace Hotel', zone: 'Trimbakeshwar', location: 'Main Market Area', coordinates: { lat: 19.9338, lng: 73.5338 }, type: 'luxury', amenities: ['AC', 'WiFi', 'Restaurant', 'Banquet Hall', 'Valet Parking'], priceRange: { min: 7000, max: 15000 }, contact: { phone: '+91-253-2723456', email: 'royal@hotel.com' }, rating: 4.9, availableRooms: 18, totalRooms: 45, status: 'available' },
  { name: 'Yatri Niwas', zone: 'Tapovan', location: 'Near Meditation Hall', coordinates: { lat: 19.8808, lng: 73.4408 }, type: 'budget', amenities: ['Fan', 'Basic Dining', 'Prayer Room'], priceRange: { min: 600, max: 1100 }, contact: { phone: '+91-253-2734567', email: 'yatri@hotel.com' }, rating: 3.6, availableRooms: 9, totalRooms: 24, status: 'available' }
];
